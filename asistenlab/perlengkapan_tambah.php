...
// Ambil kode lab yang dapat diakses oleh pengguna
$sql_lab = "SELECT l.kode_lab FROM pengguna_lab pl JOIN laboratorium l ON pl.kode_lab = l.kode_lab WHERE pl.id_pengguna = ?";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt->bind_param("sssissss", $kode_seri, $nama_perlengkapan, $jenis_perlengkapan, $set_komputer, $spesifikasi, $kode_lab, $kondisi, $status);
...
<body>
    ...
    <script>
        function confirmAdd() {
            return confirm("Apakah Anda yakin ingin menambahkan perlengkapan ini?");
        }
