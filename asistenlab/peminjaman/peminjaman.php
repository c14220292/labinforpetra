...
if (!empty($lab_codes)) {
    ...
    $sql .= " WHERE pm.laboratorium IN ($placeholders)";
        ...
        <?php else: ?>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="7" style="text-align:center;">Tidak ada data peminjaman untuk laboratorium Anda.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
        ...
        <div class="modal-content" style="max-width: 800px;">
            ...
            <div class="dropdown-container">
                <div class="dropdown-group">
                    ...
                    <select id="labSelect" name="laboratorium" onchange="filterPeminjaman()">
                        ...
                        if (!empty($lab_codes)) {
                            $placeholders = implode(',', array_fill(0, count($lab_codes), '?'));
                            $labQuery = "SELECT DISTINCT pm.laboratorium 
                                        FROM peminjaman pm
                                        JOIN perlengkapan pl ON pm.id_perlengkapan = pl.id_perlengkapan
                                        WHERE pm.status = 'Dalam Proses'
                                        AND pm.laboratorium IN ($placeholders)";
                    ...
                    <select id="setSelect" name="set_komputer" onchange="filterPeminjaman()">
                        ...
                        if (!empty($lab_codes)) {
                            ...
                            $setQuery = "SELECT DISTINCT pl.set_komputer 
                                        ...
                                        WHERE pm.status = 'Dalam Proses' 
                                        AND pm.laboratorium IN ($placeholders)
                                        AND pl.set_komputer IS NOT NULL";
            ...
            <form id="finishForm" method="POST" action="finish_peminjaman.php">
                ...
                <table style="width:100%; margin-bottom:20px;">
                    ...
                    <tbody>
                        <?php
                        // Only show borrowing records from labs the assistant has access to
                        if (!empty($lab_codes)) {
                            $placeholders = implode(',', array_fill(0, count($lab_codes), '?'));
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="4" style="text-align:center;">Tidak ada peminjaman aktif untuk laboratorium
                                        Anda</td>
                                </tr>
                            <?php endif;
                        } else {
                            echo '<tr><td colspan="4" style="text-align:center;">Anda tidak memiliki akses ke laboratorium manapun</td></tr>';
                        }
                        ?>
                    </tbody>
                </table>
