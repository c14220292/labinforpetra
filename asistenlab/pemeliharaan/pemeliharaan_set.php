...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql_perlengkapan = "SELECT id_perlengkapan FROM perlengkapan 
    ...
    $keterangan = "Set Komputer $set_komputer di laboratorium $laboratorium 
        dimasukkan ke dalam pemeliharaan pada $waktu_pemeliharaan_formatted. 
    ...
    $_SESSION['success_message'] = "Pemeliharaan berhasil ditambahkan untuk set $set_komputer dan laboratorium $laboratorium.";
...
<head>
    ...
    <title>Pemeliharaan Set Komputer</title>
