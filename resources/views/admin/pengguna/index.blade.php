        ...
        <table class="min-w-full">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $pengguna->nama_pengguna }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $pengguna->email }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ ucfirst($pengguna->role) }}</td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                        ...
                        <form action="{{ route('admin.pengguna.destroy', $pengguna) }}" method="POST" class="inline">
                            @csrf
                            @method('DELETE')
                            <button type="submit" 
