...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <form action="{{ route('admin.pengguna.update', $pengguna) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin mengubah data pengguna ini?')">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="nama_pengguna" value="{{ old('nama_pengguna', $pengguna->nama_pengguna) }}" 
                ...
                <div>
                    ...
                    <select name="role" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-petra-orange" required>
                        ...
                        <option value="kepalalab" {{ old('role', $pengguna->role) == 'kepalalab' ? 'selected' : '' }}>Kepala Lab</option>
                        <option value="asistenlab" {{ old('role', $pengguna->role) == 'asistenlab' ? 'selected' : '' }}>Asisten Lab</option>
                    </select>
                </div>
