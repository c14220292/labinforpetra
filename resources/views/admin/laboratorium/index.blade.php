...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-gradient-to-br from-petra-orange to-orange-600 text-white p-6 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition duration-300 cursor-pointer">
...
<div id="addModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white rounded-lg p-6 w-full max-w-md">
        ...
        <form action="{{ route('admin.laboratorium.store') }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menambahkan laboratorium ini?')">
            @csrf
            <div class="space-y-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Kode Lab</label>
                    <input type="text" name="kode_lab" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-petra-orange" required>
                </div>
                
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Nama Lab</label>
                    <input type="text" name="nama_lab" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-petra-orange" required>
                </div>
                
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Gedung</label>
                    <select name="gedung" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-petra-orange" required>
                ...
                <div class="flex space-x-3 pt-4">
                    <button type="button" onclick="closeModal('add')" class="flex-1 bg-gray-300 text-black py-2 rounded hover:bg-gray-400 transition">
                        Batal
                    </button>
                    <button type="submit" class="flex-1 bg-petra-orange text-white py-2 rounded hover:bg-orange-600 transition">
                        Tambah Lab
                    </button>
                </div>
            </div>
    ...
    <div class="bg-white rounded-lg p-6 w-full max-w-md">
        ...
        <div class="space-y-4">
            <div>
                ...
                <select id="deleteLabSelect" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-petra-orange">
            ...
            <div class="flex space-x-3 pt-4">
                <button type="button" onclick="closeModal('delete')" class="flex-1 bg-petra-blue text-white py-2 rounded hover:bg-blue-800 transition">
                    Tutup
                </button>
                <button type="button" onclick="confirmDeleteLab()" class="flex-1 bg-petra-orange text-white py-2 rounded hover:bg-orange-600 transition">
                    Hapus Lab
                </button>
            </div>
        </div>
...
<div id="editModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white rounded-lg p-6 w-full max-w-md">
        ...
        <div class="space-y-4">
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Laboratorium:</label>
                <select id="editLabSelect" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-petra-orange">
                    <option value="">-- Pilih Laboratorium --</option>
                    @foreach($laboratoriums as $lab)
                    <option value="{{ $lab->id_lab }}">{{ $lab->kode_lab }} - {{ $lab->nama_lab }}</option>
                    @endforeach
            ...
            <div class="flex space-x-3 pt-4">
                <button type="button" onclick="closeModal('edit')" class="flex-1 bg-petra-blue text-white py-2 rounded hover:bg-blue-800 transition">
                    Tutup
                </button>
                <button type="button" onclick="editLab()" class="flex-1 bg-petra-orange text-white py-2 rounded hover:bg-orange-600 transition">
                    Edit Lab
                </button>
            </div>
        </div>
